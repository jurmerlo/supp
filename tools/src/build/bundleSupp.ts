...
export function bundleSupp(rootDir: string, outPath: string, exclude: string[], luaVersion: LuaVersion) {
...
function getModules(rootDir: string, exclude: string[] = []): string[] {
  const modules = [];
...
function createDict(rootDir: string, modules: string[]): { [key: string]: string[] } {
...
function buildImportFile(dict: { [key: string]: string[] }): string {
  let content = '';

...
export function createLoveFile({ name, project }) {
...
export function buildProject(config, noAtlas = false, clean = false) {
    if (!noAtlas) {
        packAtlas(config);
    }
...
export function buildAndRun(config, noAtlas = false, clean = false) {

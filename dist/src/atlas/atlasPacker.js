...
export class AtlasPacker {
     ...
     */
    constructor(rectangles, packMethod, maxWidth, maxHeight) {
     ...
     */
    findPlace(startColumn, startRow, rectangle) {
    ...
    insertRect(totalWidth, totalHeight, startColumn, startRow, endColumn, endRow, rectangle) {
